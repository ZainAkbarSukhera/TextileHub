...
const Wishlist = ({ setOpenWishlist }) => {
  ...
  const addToCartHandler = (data) => {
    const newData = { ...data, qty: 1 }; // Ensure a default quantity is added
    dispatch(addTocart(newData));
    setOpenWishlist(false);
  };
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-[#0000004b] h-screen z-10">
      <div className="fixed top-0 right-0 h-full w-[80%] overflow-y-scroll 800px:w-[25%] bg-white flex flex-col shadow-sm">
        {wishlist && wishlist.length === 0 ? (
          <div className="w-full h-screen flex items-center justify-center">
    ...
    <div className="border-b p-4">
      <div className="w-full flex items-center">
        ...
        <div className="pl-[5px] flex-1">
          <h1 className="text-[16px] font-bold">{data?.name || "Unnamed Item"}</h1>
